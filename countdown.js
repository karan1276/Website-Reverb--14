(function($) {
	$.fn.countdown = function(options) {
		...
		function count_exec() {
			...
			$('h4#countdown-days').html( "<span>" + days + "</span><br/>" + "Days");
			$('h4#countdown-hours').html( "<span>" + hours + "</span><br/>" + "Hours");
			$('h4#countdown-mins').html( "<span>" + minutes + "</span><br/>" + "Minutes");
			$('h4#countdown-secs').html( "<span>" + seconds + "</span><br/>" + "Seconds");
